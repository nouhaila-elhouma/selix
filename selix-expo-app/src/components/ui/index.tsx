...
const styles = StyleSheet.create({
  ...
  orbA: { width: 320, height: 320, top: -120, right: -120, backgroundColor: 'rgba(160,62,255,0.12)' },
  orbB: { width: 260, height: 260, bottom: 60, left: -130, backgroundColor: 'rgba(255,79,216,0.12)' },
  orbC: { width: 220, height: 220, top: 220, right: -80, backgroundColor: 'rgba(255,184,77,0.08)' },
  ...
  card: {
    backgroundColor: 'rgba(28,7,47,0.94)',
    borderRadius: 28,
    borderWidth: 1,
  ...
  chipSelected: {
    backgroundColor: 'rgba(160,62,255,0.84)',
